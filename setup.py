...
setup(
    ...
    url="https://github.com/vicruiser/PDBmapper",  # Optional
    ...
    entry_points={
        ...
        # 'makeinterfacesdb=makeinterfacesdb.test:main']  # test if it works as pdbmapper /makeinterfacesdb independently
    },
