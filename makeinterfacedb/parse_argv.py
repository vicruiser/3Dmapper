...
'''
    ...
    #nnovar_group.add_argument('-pdbid', '--pdbid', nargs='+', metavar="<String>", dest="protid",
    ...
    parser.add_argument("-pdb", "--pdb", dest="pdb", metavar="<String>",
    ...
    parser.add_argument("-t", "--type", metavar="<String>", dest="type",
                        help="output directory")

    parser.add_argument("-e", "--evalue", metavar="<float>", dest="evalue",
                        help="output directory")
    
    parser.add_argument("-p", "--pident", metavar="<float>", dest="pident",
                        help="output directory")

    parser.add_argument("-c", "--coverage", metavar="<float>", dest="coverage",
                        help="output directory")

    parser.add_argument("-i", "--interaction", metavar="<String>", dest="i",
                        help="Interaction type: 'prot', 'ligand', 'nucleic', combination of the previous separated by space, or 'all'")
    # force overwrite
