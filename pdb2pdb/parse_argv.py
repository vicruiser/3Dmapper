...
def parse_commandline():
   ...
   |____/|_____/|_| |_| |_|\__,_| .__/| .__/ \___|_|   
    ...
    blast_group = parser.add_mutually_exclusive_group(required=True)
    blast_group.add_argument('--blast_db', dest="blastdb", metavar="<String>",
                        help='Blast DB files path (output of makeblastdb)')
    blast_group.add_argument('--pdb2pdb', dest="pdb2pdb", action='store_true',
                        help='Activate for mapping from PDB to PDB positions.', default = False)
